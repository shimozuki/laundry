                ...
                <div class="col-lg-6 col-12 p-0">
                    <div class="card rounded-0 mb-0 px-2">
                        ...
                        <div class="login-footer">
                            ...
                            <p style="font-size:10px;text-align:center">Build With <i class="feather icon-heart text-danger"></i> by <a href="https://github.com/shimozuki" target="_blank">shimozuki</a></p>
                        </div>
                    </div>
                </div>
            </div>
